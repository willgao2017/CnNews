...
public class NewsAdapter extends ArrayAdapter<Newsarticle> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
       ...
       // TextView magnitudeView = (TextView) listItemView.findViewById(R.id.magnitude);
        ...
        String formattedMagnitude = formatMagnitude(currentNewsarticle.getMagnitude());
       ...
       // int magnitudeColor = getMagnitudeColor(currentNewsarticle.getMagnitude());
       ...
       // magnitudeCircle.setColor(magnitudeColor);
        ...
        TextView dateView = (TextView) listItemView.findViewById(R.id.article_author);
